...
const madlib = "The intro to Javascript course is" + " " + adjective1 + ".James and \n" +
                "Julia are so" +" " + adjective2 + ". I cannot wait to work through the \n" +
               "rest of this" + " " + adjective3 + " " + "content!";
console.log(madlib);